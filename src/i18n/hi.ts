export default {
  ...
  // Kiosk Terminal
  kiosk_title: 'उपस्थिति कियोस्क',
  kiosk_welcome: 'कक्षा में आपका स्वागत है',
  kiosk_instruction: 'शुरू करने के लिए कृपया अपना पंजीकृत फोन नंबर या ईमेल दर्ज करें।',
  kiosk_input_placeholder: 'e.g. 9876543210 or email@domain.com',
  kiosk_verifying_student: 'छात्र का सत्यापन कर रहे हैं...',
  kiosk_next_verify_face: 'अगला: चेहरा पहचानें',
  kiosk_manual_checkin: 'मैन्युअल चेक-इन',
  kiosk_exit: 'कियोस्क मोड से बाहर निकलें',
  kiosk_camera_permission_required: 'उपस्थिति कियोस्क के लिए कैमरा दिखाने के लिए हमें आपकी अनुमति चाहिए।',
  kiosk_grant_permission: 'अनुमति दें',
  kiosk_scanning_face: 'चेहरा स्कैन कर रहे हैं...',
  kiosk_look_camera: 'कृपया कैमरे की ओर देखें',
  kiosk_verifying: 'सत्यापन हो रहा है...',
  kiosk_capture_verify: 'कैप्चर करें और सत्यापित करें',
  kiosk_back: 'पीछे',
  kiosk_manual_desc: 'यदि चेहरा पहचान विफल हो जाती है या छात्र का प्रोफाइल फोटो नहीं है, तो उनका पंजीकृत फोन या ईमेल उपयोग करें।',
  kiosk_phone_email: 'फोन या ईमेल',
  kiosk_mark_attendance: 'उपस्थिति दर्ज करें',
  kiosk_submitting: 'जमा हो रहा है...',
  kiosk_err_network: 'नेटवर्क त्रुटि। सर्वर से कनेक्ट नहीं हो सका।',
  kiosk_err_timeout: 'चेहरा सत्यापित नहीं हो सका। कृपया अपना चेहरा करीब लाएं और पुनः प्रयास करें।',
  kiosk_err_verification_failed: 'सत्यापन विफल',
  kiosk_err_recognition_failed: 'पहचान विफल',
  kiosk_err_manual_failed: 'मैन्युअल चेक-इन विफल',
  kiosk_launch: 'कियोस्क मोड लॉन्च करें',
};
